(async function () {
  ...
  //const snakeHead = await loadImage('images/snakeHead.png');
  //setTimeout(gameLoop, speed);
  //const snake = new Snake();
  ...
  //const appleImg = await loadImage('images/apple.png');
  //const apple = new Apple();

  const snakeP = loadImage('images/snakeHead.png');
  const appleP = loadImage('images/apple.png');

  const [snakeHead, appleImg] = await Promise.all([snakeP, appleP]);
  //const snakeHead = images[0];
