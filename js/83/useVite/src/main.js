...
import crashSoundSrc from './media/crash.mp3';
import crunchSoundSrc from './media/crunch.mp3';
...
crunchSound.src = crunchSoundSrc;
...
const snakeHeadP = loadImage(snakeSrc);
const appleImgP = loadImage(appleSrc);
